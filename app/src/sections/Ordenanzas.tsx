...
const ordenanzasData: Record<string, { name: string; file: string }[]> = {
  ...
  "2024": [
    { name: "Impuesto sobre Actividades Económicas", file: "ORD 1745(VIGENTE Mar-24).pdf" },
    { name: "Impuesto sobre Juegos y Apuestas Lícitas", file: "ORD 1746AL ABRIL 2024.pdf" },
    { name: "Tasas por Uso de Espacios Públicos y Servicios Administrativos (Reforma Abril 2024)", file: "ORD_OTA ESPACIOS PUBLICOS ABRIL 2024.pdf" },
    { name: "Emprendimientos y su Régimen Simplificado", file: "ORD_EMPRENDIMIENTO ABRIL 2024.pdf" },
    { name: "Impuesto sobre Propaganda y Publicidad Comercial", file: "ORD_GME 1668 OPPC (VIGENTE 2024).pdf" },
    { name: "Impuesto sobre Espectáculos Públicos", file: "ORD_GME 1669 OEP (VIGENTE 2024).pdf" },
    { name: "Registro y Autorización para el Expendio de Bebidas y Especies Alcohólicas", file: "ORD_GME 1670 OEBA (VIGENTE 2024).pdf" },
    { name: "Tasas por Uso de Espacios Públicos y Servicios Administrativos (Noviembre 2023)", file: "ORD_GME 1671 OTA (VIGENTE 2024).pdf" },
    { name: "Impuesto sobre Vehículos", file: "ORD_GME 1672 OIVH (VIGENTE 2024).pdf" }
  ],
  "2023": [
